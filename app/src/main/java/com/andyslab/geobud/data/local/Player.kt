...
class Player(private val context: Context) {
    ...
    companion object{
        ...
        var instance = PlayerDto()
    }

    suspend fun loadPlayerData(): PlayerDto {
        ...
        return (gson.fromJson(json, PlayerDto::class.java) ?: PlayerDto()).also{
            instance = it
        }
    }

    suspend fun savePlayerData(player: PlayerDto) {
        val dataStoreKey = stringPreferencesKey(PLAYER_DATA_KEY)
